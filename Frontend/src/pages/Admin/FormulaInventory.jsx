    ...
    <div className="inventory-page p-6 bg-gray-100 min-h-screen">
      ...
      <div className="mb-4">
        <input
          ...
          className="w-2/4 px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500"
        />
      </div>
      ...
      <div className="user-inputs mb-8 text-center">
        <div className="flex flex-wrap justify-center gap-4">
          <input
            ...
            className="w-full sm:w-64 px-4 py-2 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-green-500 placeholder-gray-500"
            placeholder="Shift"
          />
          <input
            type="text"
